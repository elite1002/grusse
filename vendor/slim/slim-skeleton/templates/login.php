		...
		<div class="container-fluid">	    
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				...
				<ul class="nav navbar-nav ">
					<!--那些按鈕     -->
					<li><a style = "margin-right: 20px; " class="navbar-brand page-scroll" href="#page-top"> Grusse </a></li>
					<li><a class="navbar-brand page-scroll" href="#"> Login </a> </li>
			...
			<!--在最右邊-->    <!-- .nav-justified 平分--> 
			<ul class="nav navbar-right navbar-form nav-pills">
				...
				<hr>
					<form class="form-horizontal" method="post" action="#">
						...
						<div class="form-group ">
							...
							<button type="button" class="btn btn-primary btn-lg btn-block login-button">Log In</button>
						</div>
